...
<head>
    ...
    <link href="{{asset('css/convert-pdf/css-cc-payment.css')}}" rel="stylesheet">
...
{{--                    <span class="font-title-rp-income number">{{$balance}}</span>,- </p>--}}
{{--            </div>--}}
                            ...
                            <ion-item>
                                <ion-grid>
                                    ...
                                    @foreach($content as $item)
                                        <ion-row class="list-item font-weight-normal">
                                            <ion-col class="list-item-icon">

                                                <img
                                                    src="{{ $item->ccLog->cc->icon_id ? $item->ccLog->cc->icon_url : asset('img/ic_wallet.svg')}}"
                                                    class="col-icon">

                                            </ion-col>
                                            <ion-col class="list-item-note">
                                                <div> {{$item->ccLog->cc->name}}</div>
                                                <div> {{$listText . $item->ccLog->cashbank->name}}</div>
                                                <div> {{$item->note}} </div>
                                            </ion-col>
                                            <ion-col class="list-item-amount font-color-red">
                                                <div class="font-rp-spending number">
                                                    {{$item->amount}}
                                                </div>
