                                    ...
                                    @foreach($content as $item)
                                        <ion-row class="list-item">
                                            <ion-col class="list-item-icon">
                                                @php
                                                    $icon_url = asset('img/ic_wallet.svg');
                                                    $name = '-';
                                                    $amount = '-';
                                                    if( $item->loan != null){
                                                        $icon = $item->loan->icon_url;
                                                        $name = $item->note ? $item->note  : '-';
                                                        $amount = $item->amount;
                                            ...
                                            <ion-col class="list-item-amount font-color-blue ">
                                                <div class="font-rp-income number">
                                                    {{$amount}}
                                                </div>
                                            </ion-col>
                                        </ion-row>
...
<script>
    ...
    chartData = chartData.map((item) => {
        return {'label': item.name, 'value': item.total_income}
    });
    ...
    createPieChart(chartData, 'income');
